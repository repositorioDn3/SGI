 ...
 <div wire:ignore.self data-backdrop="static" class="modal fade" id="addImovel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          <form wire:submit.prevent='save' enctype="multipart/form-data" class="col-md-12 d-flex justify-content-between align-items-center flex-wrap" >
            ...
            <div class="col-md-4">
              <label for="preco_total">Preço toal:</label>
